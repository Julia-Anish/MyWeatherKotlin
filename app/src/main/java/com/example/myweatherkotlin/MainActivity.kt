    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val updateAtText = "Updated at: " + SimpleDateFormat("dd/MM/yyy", Locale.UK).format(Date(updateAt*1000))
                val sunrise = sys.getLong("sunrise")
                val sunriseAt = SimpleDateFormat ("hh:mm a", Locale.UK).format(Date(sunrise*1000))
                val sunset = sys.getLong("sunset")
                val sunsetAt = SimpleDateFormat ("hh:mm a", Locale.UK).format(Date(sunset*1000))
